...
class Perusahaan extends CI_Controller {
	 ...
	 * @web : http://aldes.id
	 * @keterangan : Controller untuk halaman khusus perusahaan
	 */
	...
	public function index()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$bc['menu'] = $this->load->view('perusahaan/menu', '', true);
			$bc['bio'] = $this->load->view('perusahaan/bio', $bc, true);
			
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_home',$bc);
		...
		public function hapus_oras()
	{
		...
		if(!empty($cek) && $stts=='admin' || $stts=='perusahaan')
		{
			...
			header('location:'.base_url().'perusahaan/orangasing');
		}
		else
		{
			header('location:'.base_url().'web');
	...
	public function orangasing()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$config['base_url'] = base_url() . 'perusahaan/orangasing/';
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_orang_asing',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
  ...
  public function orangasingbekerja()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_orang_asing_bekerja',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
   ...
   public function orangasingtidakbekerja()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_orang_asing_tidak_bekerja',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
		...
		public function data_masuk()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$config['base_url'] = base_url() . 'perusahaan/data_ormas/';
			$config['total_rows'] = $tot_hal->num_rows();
			$config['per_page'] = $limit;
			$config['uri_segment'] = 3;
			$config['first_link'] = 'Awal';
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_masuk',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
 ...
 $this->db->select('*');
    ...
    $this->db->where('id_ormas', $this->uri->segment(3));
   	$bc['ormas']=$this->db->get();
			$this->load->view('perusahaan/bg_edit_ket.php',$bc);
	...
	public function detail_ormas()
	{
		...
		//	$bc['ormas'] = $this->web_app_model->getEditMahasisiwa($this->uri->segment(3));
			$this->load->view('perusahaan/bg_edit_ormas',$bc);
		}
		else
		{
			header('location:'.base_url().'web');
	...
	public function tambah_ormas()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('perusahaan/bg_tambah_ormas',$bc);
		}
		else
		{
			header('location:'.base_url().'web');
 ...
 $this->db->select('*');
    ...
    $this->db->where('id_ormas', $this->uri->segment(3));
   	$bc['ormas']=$this->db->get();
			$this->load->view('perusahaan/bg_status',$bc);
 ...
 $this->db->select('*');
    ...
    $this->db->where('id_ormas', $this->uri->segment(3));
   	$bc['ormas']=$this->db->get();
			$this->load->view('perusahaan/bg_persetujuan',$bc);
		...
		//		$this->web_app_model->updateDataMultiField("tbl_dosen_wali",$simpan2,$where);
      	...
      	if($st=="edit")
			...
			else if($st=="tambah")
			{
				...
				header('location:'.base_url().'perusahaan/tambah_ormas');
				}
			}
		}
		else
	...
	public function hapus_ormas()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			header('location:'.base_url().'perusahaan/skt');
		}
		else
		{
			header('location:'.base_url().'web');
	...
	public function skt()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_skt',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
	...
	public function input_skt()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_input_nilai',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
	...
	public function edit_skt()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('perusahaan/bg_edit_nilai',$bc);
		}
		else
		{
			header('location:'.base_url().'web');
	...
	public function form_input_skt()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('perusahaan/bg_form_input_nilai',$bc);
		}
		else
		{
			header('location:'.base_url().'web');
	...
	public function hapus_skt()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			header('location:'.base_url().'perusahaan/input_nilai/'.$dl['nim']);
		}
		else
		{
			header('location:'.base_url().'web');
		...
		public function laporan()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$bc['username'] = $this->session->userdata('username');
			$bc['menu'] = $this->load->view('perusahaan/menu', '', true);
			$bc['menu2'] = $this->load->view('perusahaan/menu2', '', true);
			$bc['bio'] = $this->load->view('perusahaan/bio', $bc, true);
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_laporan',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
		...
		public function laporan_proses()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_laporan_proses',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
		...
		public function laporan_status()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_laporan_status',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
		...
		public function laporan_pengaduan()
	{
		...
		if(!empty($cek) && $stts=='perusahaan')
		{
			...
			$this->load->view('global/bg_top_admin',$d);
			$this->load->view('perusahaan/bg_laporan_pengaduan',$bc);
			$this->load->view('global/bg_footer_admin',$d);
		}
		else
		{
