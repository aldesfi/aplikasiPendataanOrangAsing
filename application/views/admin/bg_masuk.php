...
<div id="container">
	...
	<td align="center">Lambang </td>	
	<td align="center">Bendera</td>	
    ...
    <?php echo $d['sek']; ?>
     ...
     <?php echo $d['bendahara']; ?>
			...
			<td align="center"><img src="../gambar/<?php echo $d['lambang']; ?>" alt="lambang" height="42" width="42"></td>
			<td align="center"><img src="../gambar/<?php echo $d['bendera']; ?>" alt="bendera" height="42" width="42"></td>
        ...
        <a href="'.base_url().'admin/konfirmasi/'.$d['id_ormas'].'" rel="example_group" class="link" style="float:left;">Proses SKT</a>
				</td>
        <td align="center" width="60">
