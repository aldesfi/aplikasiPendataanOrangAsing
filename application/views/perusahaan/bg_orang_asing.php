...
<h1>Daftar Orang Asing</h1>
	...
	<td colspan="9" align="center" bgcolor="#fff" style="text-transform:uppercase;"><strong>DAFTAR ORANG ASING</strong></td>
    ...
    $no=0;
      ...
      $no++;
        ...
        <td align="center" width="60">
				...
				<a href="'.base_url().'perusahaan/hapus_oras/'.$d['id_orang_asing'].'"
